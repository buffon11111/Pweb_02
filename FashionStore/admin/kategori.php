        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
          <div class="container-fluid navbar-inner">
            <a href="../dashboard/index.html" class="navbar-brand">
                ...
                <h4 class="logo-title">Fashion Store</h4>
            </a>
   ...
   <div class="row">
         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               <div class="header-title">
                  <h4 class="card-title">Tambah Jenis Klik Disini !!</h4>
                  <a class="btn btn-primary" href="tambah_jenis.php">Tambah</a>
               </div>
            </div>
            <div class="card-body">
    ...
    <tbody>
        ...
        <tr style="text-align: center;">
            ...
            <td><?=$row['nama']?></td>
            <td>
                <a class="btn btn-primary" href="detail_kategori.php?id=<?=$row['id']?>">View</a>
